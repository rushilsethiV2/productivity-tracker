...
import { Calendar as CalendarIcon, TrendingUp, Flame, CheckCircle, Dumbbell, Target, ChevronLeft, ChevronRight, BookOpen, Database } from 'lucide-react';
      ...
      <div className="max-w-[1800px] mx-auto">
        <header className="mb-8 flex items-start justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--card))] hover:bg-[rgb(var(--background))] text-gray-300 hover:text-white transition-colors group"
            title="Data & Sync Manager"
          >
            <Database className="w-5 h-5 group-hover:text-blue-400 transition-colors" />
            <span className="hidden sm:inline text-sm font-medium">Data & Sync</span>
          </button>
        </header>
